...
using TMPro;
public class DrawPhysicLineOriginVer : MonoBehaviour
{
    public Slider R;
    public Slider G;
    public Slider B;
    ...
    void drawLine()
    {
        if (Input.touchCount == 1)
        {
            ...
            var OriginP = Camera.main.transform.TransformPoint(0, 0, 0.1f);
            p = _originDecideFromImageMaker.WorldToOriginLocal(OriginP);
